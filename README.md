...
Migrating from 3rd Party AV to Microsoft Defender Anti-Virus (MDAV) and Onboarding to Microsoft Defender for Endpoint (MDE) can be a complex process depending on your current AV vendor, organizational policies, infrastructure, etc. However, the following is a process I have developed through trial and error. The Migrate2MDAV-Win10.zip file is a Task Sequence template for SCCM/MECM that can be imported as a Task Sequence for AV migrations on Windows 10 and Server 2019. It is assumed the user of this file understands how to build/run a Task Sequence, Packages, etc. You must edit and configure the Tasks to meet your organization's requirements. This is the order of actions I have found to work; however, you may find a different variation that works for your environment.
